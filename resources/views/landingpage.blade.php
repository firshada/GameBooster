...
<div class="container mt-4">
    ...
    <div class="container row mb-5">
        ...
        <section class="mx-auto" style="max-width: 23rem;" >
            <div class="card p-4" data-aos="fade-up" data-aos-duration="500" data-aos-offset="500">
              ...
              <div class="bg-image hover-overlay ripple rounded-0 d-flex justify-content-center" data-mdb-ripple-color="light">
                ...
                <a href="#!">
                  <div class="mask" style="background-color: rgba(227,226,222,255);"></div>
                </a>
              </div>
            </div>
          </section>
    ...
    <div class="services col" data-aos="fade-up" data-aos-duration="500" data-aos-offset="500">
        <h2 class="pt-4" >Our Services</h2>
        <p data-aos="fade-up">Enjoy Our Services</p>
        <div class="row">
            @foreach ( $games as $g)   
            <div class="col-md-3 d-flex justify-content-center py-3" data-aos="fade-up" data-aos-duration="500" data-aos-delay="250">
    ...
    <div class="news col" data-aos-offset="1200">
        <h2 class="pt-4" data-aos="fade-up" data-aos-duration="500">News</h2>
        <p class="pb-3" data-aos="fade-up"  data-aos-duration="500">Hot news about new games and update</p>
        
        <div class="container row gx-5" data-aos="fade-right" data-aos-duration="500">
            @foreach ( $news as $n )   
            ...
            <div class="col-md-6 mb-4" data-aos="fade-left" data-aos-duration="500" data-aos-delay="200">
